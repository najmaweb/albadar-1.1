        ...
        <table id="rpt" width=100%>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan=3><?php echo $spptext;?></td><td colspan=2 class="rightaligned number"><?php echo  "Rp. " . number_format($spp);?></td>
                </tr>
                <?php 
                $counter++;
                }?>
                <?php if($withbimbel){?>
                <tr><td class="centeraligned number"><?php echo $counter;?></td><td colspan=3><?php echo $bimbeltext; ?></td><td colspan=2 class="rightaligned number"><?php echo  "Rp. " . number_format($bimbel);?></td></tr>
                <?php 
                $counter++;
                }?>
                <?php if($book){?>
